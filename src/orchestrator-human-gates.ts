...
import { formatCandidateForApproval, messageOf, raceWithAbort } from "./orchestrator-helpers.js";
import { persist } from "./orchestrator-state.js";
import { GateInteractionError, HumanGateUnavailableError, WorkflowCancelledError, WorkflowTerminationError } from "./workflow-errors.js";
...
export async function runRequiredHumanGate<T>(
  ...
  state.humanGate = { kind, label, startedAt: runtime.timestamp() };
