...
This project is indexed by GitNexus as **piOrchestrator** (4566 symbols, 14568 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
